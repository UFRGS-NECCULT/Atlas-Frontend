...
export const descriptions: IDescriptions = [
  ...
  // Eixo 3
  {
    ...
    8: [
      [
        "RAZÃO ENTRE FINANCIAMENTO {{ mec }} {{ uf or 'NO BRASIL' }} {{ 'PARA O SETOR ' + cad if cad }} E VALOR ADICIONADO {{ 'PELO SETOR ' + cad if cad  else 'PELOS SETORES CULTURAIS E CRIATIVOS' }} {{ uf or 'NO BRASIL' }}"
